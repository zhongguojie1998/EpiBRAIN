...
- [Usage](#usage)
  - [Only do variant effect predictions](#only-do-variant-effect-predictions)
  - [Only to generate labels (h5 files) from bigWig files](#only-to-generate-labels-h5-files-from-bigwig-files)
