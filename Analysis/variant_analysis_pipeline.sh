...
usage() {
    ...
    echo "  --track TRACK               Cell type/track name (e.g., BasalGanglia-STR-D1-MSN_RNAminus), must match one of the trials in the regression_label_meta.csv file under Chk/"
    echo "                              NOTE: The RNAminus is + strand and RNAplus is - strand"
    echo ""
